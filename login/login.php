...
<div class="ship_picture">
    <img src="img/spaceship1.png" alt="spaceship1">
</div>
		...
		<div class="user_card">
			<div class="d-flex justify-content-center">
				<div class="brand_logo_container">
					<img src="img/logo.png" class="brand_logo" alt="SpaceMan logo">
				</div>
			</div>	
			...
			<div class="mt-4">
				<div class="d-flex justify-content-center links">
					Don't have an account? <a href="\UserAccounts\registration.php" class="ml-2">Sign Up</a>
				</div>
				<div class="d-flex justify-content-center">
